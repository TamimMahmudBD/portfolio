...
const Navbar = () => {
  ...
  return (
    <div 
      className={
        shadow
          ? 'xl:fixed bg-[#ecf0f3] dark:bg-black w-full mt-0 h-16 shadow-xl z-[100] ease-in-out duration-300 '
 ...
 {/* Mobile Menu */}
      ...
      <div className={nav ? 'md:hidden fixed left-0 top-0 w-full h-screen bg-black/70 dark:text-black' : ''}>
        <div  className={nav ? 'md:hidden px-4 fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ecf0f3] ease-in duration-500' : 'px-4 fixed left-[-100%] top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ecf0f3] ease-in duration-500'}>
          ...
          <div className='py-4'>
            ...
            <div className='pt-10 uppercase tracking-widest '>
              <p>Let's Connect</p>
